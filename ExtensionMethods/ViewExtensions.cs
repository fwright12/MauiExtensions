...
[ContentProperty(nameof(GestureRecognizerTemplate))]
public class AddGestureRecognizerBehavior : Behavior<View>
{
    ...
    protected override void OnAttachedTo(View bindable)
    {
        ...
        if (GestureRecognizerTemplate?.CreateContent() is IGestureRecognizer gestureRecognizer)
        {
...
public class ClearGestureRecognizersBehavior : Behavior<View>
{
    protected override void OnAttachedTo(View bindable)
    {
        base.OnAttachedTo(bindable);
...
public static class ViewExtensions
{
    ...
    private static void GestureRecognizersChanged(BindableObject bindable, object _oldValue, object _newValue)
    {
        ...
        var oldValue = _oldValue as DataTemplate;
        var newValue = _newValue as DataTemplate;
